...
interface UsersTabProps {
  ...
  profileRole: 'Admin' | 'Manager' | 'IT Support' | 'Staff';
  setProfileRole: (val: 'Admin' | 'Manager' | 'IT Support' | 'Staff') => void;
  profileDept: string;
  ...
  return (
    selectedUserProfileUser ? (
      <motion.div 
        ...
        className="space-y-6 text-[#191b23] text-left"
      >
        {/* Breadcrumbs */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 bg-white border border-outline-variant rounded-2xl p-6 shadow-sm space-y-6">
            ...
            <form onSubmit={(e) => {
              ...
              const updatedUser = selectedUserProfileUser ? {
                ...selectedUserProfileUser,
                name: profileName,
                phone: profilePhone,
                role: profileRole,
              ...
              setSelectedUserProfileUser(updatedUser);
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-white border border-outline-variant rounded-2xl p-5 shadow-sm space-y-4">
              ...
              <div className="relative pl-4 border-l-2 border-slate-100 space-y-5 text-xs">
                ...
                <div className="relative">
                  <span className="absolute -left-[23px] top-0 bg-red-50 border-2 border-white rounded-full p-0.5 text-red-600">
        ...
        <div className="bg-white border border-outline-variant rounded-xl overflow-hidden shadow-sm">
          ...
          <div className="bg-gray-50 border-t border-[#ededf9] px-5 py-3 flex items-center justify-between font-sans">
            ...
            <div className="flex gap-1">
              ...
              <button className="px-3 py-1 border border-outline-variant hover:bg-white text-[11px] rounded cursor-pointer" onClick={() => triggerToast('Tất cả địa chỉ thư mục đã được đồng bộ hóa!')}>Sau</button>
            </div>
          </div>
        </div>
      </div>
